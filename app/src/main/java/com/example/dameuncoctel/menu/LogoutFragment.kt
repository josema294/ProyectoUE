...
import com.example.dameuncoctel.login.LoginFragment
...
class LogoutFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var viewFragmentLogout= inflater.inflate(R.layout.fragment_logout,container,false)
        logOut= viewFragmentLogout.findViewById(R.id.logout_icon)
